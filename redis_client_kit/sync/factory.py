"""Factory functions for creating sync Redis clients."""
...
def _create_single_client(
    ...
    """Create single-instance sync Redis client with connection pool."""
    logger.info(
...
def _create_cluster_client(
    ...
    """Create sync Redis Cluster client with connection pool."""
